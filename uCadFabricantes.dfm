object frmCadFabricantes: TfrmCadFabricantes
  Left = 245
  Top = 302
  BorderIcons = []
  Caption = 'Cadastro e manuten'#231#227'o de Fabricantes'
  ClientHeight = 292
  ClientWidth = 631
  Color = clBtnFace
  ...
  object cdsCadFabricantes: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspCadFabricantes'
    Left = 216
    Top = 223
  end
  ...
  object dspCadFabricantes: TDataSetProvider
    DataSet = qryCadFabricantes
    Left = 216
    Top = 167
  end
  object qryCadFabricantes: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
