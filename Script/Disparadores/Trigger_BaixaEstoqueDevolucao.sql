...
CREATE TRIGGER BaixaEstoqueDevolucao
...
DECLARE ItensDevolucoes CURSOR FOR ( SELECT COD_PRODUTO, QTDE_DEVOLVIDA FROM INSERTED )
BEGIN

   OPEN ItensDevolucoes
   FETCH NEXT FROM ItensDevolucoes INTO @parCod_Produto,@parQtde_Devolvida
